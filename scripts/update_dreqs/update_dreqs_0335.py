#!/usr/bin/env python
"""
update_dreqs_0335.py

This file creates a data request for three additional variables for EC-Earth's
HR contributions to WP5.
"""
...
def main(args):
    ...
    variant_labels = ['r{}i1p2f1'.format(i) for i in range(1, 25)]

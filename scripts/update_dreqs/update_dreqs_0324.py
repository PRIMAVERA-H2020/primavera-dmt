#!/usr/bin/env python
"""
update_dreqs_0324.py

This file creates data requests for MOHC fx variables.
"""
...
def main(args):
    ...
    institute_details = {
        'id': 'MOHC',
        'model_ids': ['HadGEM3-GC31-LL', 'HadGEM3-GC31-MM', 'HadGEM3-GC31-MH',
                      'HadGEM3-GC31-HH'],
